...
#Use conditionals such as if, else, and elif statements to lay out the logic and 
#the story's path in your program.
...
if move.lower() == "left":
    ...
    if move.lower() == "wait":
        move = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n")
